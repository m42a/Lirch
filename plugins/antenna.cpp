...
void run(plugin_pipe p, string name)
{
	...
	while(true)
	{
		...
		while (udpSocket.hasPendingDatagrams())
		{
			...
			QString destinationChannel=QString::fromUtf8(broadcast+4,64).section('\0',0,0);
			QString senderNick=QString::fromUtf8(broadcast+68,64).section('\0',0,0);
			QString sentContents=QString::fromUtf8(broadcast+132,256).section('\0',0,0);
